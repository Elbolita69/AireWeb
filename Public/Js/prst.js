...
function saveProject() {
  ...
  if (!nombre || !direccionInicial || !direccionFinal || !municipio || !departamento || 
      !numPostes || !fechaInicio || !fechaFin || !puntoConexion) {
  ...
  try {
      ...
      // Guardar proyecto (la generación del ID ocurre en Storage.saveProject)
